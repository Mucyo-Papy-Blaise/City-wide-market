...
import { CardDetailsProps } from "../Data/Data"
interface DesignProps{
  DesignCards:CardDetailsProps[]
}

const AllDesigns:React.FC<DesignProps> = ({DesignCards}) => {
          ...
          >
            ...
            <div className="flex flex-col gap-1">
              <div className="flex flex-row justify-between">
                ...
                <p className={`${
                  DesignCard.status === "Published" ?
                    "bg-teal text-white font-semibold p-1 rounded-full w-fit text-[10px]" :
                    "bg-terracotta text-white font-semibold p-1 rounded-full w-fit text-[10px]"
                }`}>
                  {DesignCard.status}
                </p>
              </div>
